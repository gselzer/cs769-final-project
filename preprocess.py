...
def preprocess(args: argparse.Namespace):
    ...
    os.system(f"cp data-bin/dict.{SRC_LANG}.txt data/joined-dict.txt")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--src', choices=["de", "ne"], help='the source language', default="ne")
    parser.add_argument('--tgt', choices=["en"], help='the target language', default="en")
    # Parse techniques
