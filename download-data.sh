...
# ADAPTED FOR CS769 FINAL PROJECT BY: Gabriel Selzer, Luke Neuendorf, Zach Potter
...
GLOBAL_VOICES_URL="https://opus.nlpl.eu/download.php?f=GlobalVoices/v2018q4/moses/en-ne.txt.zip"

download_data $GLOBAL_VOICES.zip $GLOBAL_VOICES_URL
unzip -o $GLOBAL_VOICES.zip -d $NE_ROOT
